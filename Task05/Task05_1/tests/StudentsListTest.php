...
class StudentsListTest extends TestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        self::$student1->setLastname('Кручинкин')->setName('Александр')->setFaculty('Математики')->setCourse(2)->setGroup(302);
        self::$student2 = new Student();
        self::$student2->setLastname('Иванов')->setName('Иван')->setFaculty('Физики')->setCourse(2)->setGroup(302);
        self::$student3 = new Student();
        self::$student3->setLastname('Васильев')->setName('Василий')->setFaculty('Химии')->setCourse(2)->setGroup(302);
    }
